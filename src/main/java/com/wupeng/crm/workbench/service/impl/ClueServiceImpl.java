...
import com.wupeng.crm.workbench.dao.*;
import com.wupeng.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        for (ClueActivityRelation clueActivityRelation:clueActivityRelationList){
            ...
            //创建 联系人与市场活动的关联关系对象 让第三步生成的联系人对象和市场活动关联
        ...
        //(6)如果有创建交易需求，创建一条交易
        if(t!=null){
            //t中已有id，money，name，expectedDate，stage，activityId，createTime，createBy
