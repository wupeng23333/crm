...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //为放大镜图标，绑定事件，打开搜索市场活动模态窗口
            $("#openSearchModelBtn").click(function () {
                $("#searchActivityModal").modal("show")

            })

            //为搜索操作模态窗口的搜索框，绑定搜索事件展现市场活动列表
            ...
            $("#convertBtn").click(function () {
                /*
                    提交请求到后台，发起传统请求，响应完后回到线索列表页
                    根据为客户创建交易是否打√，决定是否创建交易
                 */
                if ($("#isCreateTransaction").prop("checked")) {
                    //alert("需要创建交易")
                    //此方式很麻烦，且表单扩充，参数草果浏览器地址字符上限
...
<div id="create-transaction2"
    ...
    <form id="tranForm" action="workbench/clue/convert.do" method="post">
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="openSearchModelBtn"
